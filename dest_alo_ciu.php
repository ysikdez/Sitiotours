...
?>
	<h5>
		<a class="" onclick="quitarDestAloja('ciualoja')">
			<?=$tit_pos_pagina?> <i class="icon-remove"></i>
		</a>
	</h5>
	<input type="hidden" name="ciualoja" value="<?=$ids?>">
<?php
} 
...
?>
	<h5>
		<a class="" onclick="quitarDestAloja('ciualoja')">
			<?=$tit_pag_ciudad?> <i class="icon-remove"></i>
		</a>
	</h5>
	<input type="hidden" name="ciualoja" value="<?=$id_pag_ciudad?>">
<?php
}
