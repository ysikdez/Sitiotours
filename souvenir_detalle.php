...
$dato_pagina = "SELECT * FROM (pagina LEFT JOIN souvenir ON pagina.id_pagina = souvenir.id_pagina) WHERE pagina.id_pagina='$id'";
			...
			<div class="row">
				<div class="span8">
					...
					<article class="span8 text-center">
								...
								<dd>
									<?php
										...
										$dato_destino = "SELECT pagina.id_pagina ,destino.id_destino ,pagina.tit_pos_pagina ,pagina.url_pagina
																FROM
																((souvenir LEFT JOIN destino ON souvenir.id_destino = destino.id_destino)
																LEFT JOIN pagina ON pagina.id_pagina = destino.id_pagina)
																WHERE
																souvenir.id_souvenir='$id_souvenir'";
						...
						<p class="text-justify"><?=$des_souvenir?></p>
						<h4 class="text-left">Material :</h4>
						<p class="text-justify"><?=$mat_souvenir?></p>
						<h4 class="text-left">Elaboracion :</h4>
						<p class="text-justify"><?=$ela_souvenir?></p>
						<br><br>
						<p>
							<?php
