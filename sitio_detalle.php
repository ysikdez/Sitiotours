...
$dato_pagina = "SELECT * FROM (pagina LEFT JOIN sitio ON pagina.id_pagina = sitio.id_pagina) WHERE pagina.id_pagina='$id'";
			...
			<div class="row">
				<div class="span8">
					...
					<article class="span8 text-center">
								...
								<dd>
									<?php
										...
										$dato_destino = "SELECT pagina.id_pagina ,destino.id_destino ,pagina.tit_pos_pagina ,pagina.url_pagina
																FROM
																((sitio LEFT JOIN destino ON sitio.id_destino = destino.id_destino)
						...
						<p class="text-justify"><?=$des_sitio?></p>
						<br><br>
						<p>
							<?php
