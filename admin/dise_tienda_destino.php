...
//Datos del tienda
$pos_tour = "SELECT * FROM tienda WHERE id_pagina='$ids'";
...
if (!$_POST) {
	...
	if ($region=="Ninguna") {
		...
		//Nuevo destino
		$nuevo_destino = "UPDATE tienda SET id_destino = $id_new_des WHERE id_pagina='$ids'";
	...
	header("location: dise_tienda_destino.php?id=$ids&error=$error");
}
