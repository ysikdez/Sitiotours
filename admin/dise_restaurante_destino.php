...
$pos_tour = "SELECT * FROM restaurante WHERE id_pagina='$ids'";
...
if (!$_POST) {
	...
	if ($region=="Ninguna") {
		...
		//Nuevo destino
		$nuevo_destino = "UPDATE restaurante SET id_destino = $id_new_des WHERE id_pagina='$ids'";
	...
	header("location: dise_restaurante_destino.php?id=$ids&error=$error");
}
