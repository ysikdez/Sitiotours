...
if (!$_POST) {
	...
	$arch_ima_pri = $_POST["arch_ima_prin"];
	...
	if( $tamano < 614400 ){
		...
		// $error=$id_ima_prin.$id_letrero;echo $error;

	//$error=$ico_letrero.$fec_ima_prin.'--'.$val;

	header("location: imagen_prin.php?id=$id&error=$error");
}
