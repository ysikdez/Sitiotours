...
$pos_tour = "SELECT * FROM alojamiento WHERE id_pagina='$ids'";
...
if (!$_POST) {
	...
	if ($region=="Ninguna") {
		...
		//Nuevo destino
		$nuevo_destino = "UPDATE alojamiento SET id_destino = $id_new_des WHERE id_pagina='$ids'";
	...
	header("location: dise_alojamiento_destino.php?id=$ids&error=$error");
}
