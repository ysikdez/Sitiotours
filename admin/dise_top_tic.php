...
//Datos de los de Top 10 comentarios

	$top_comentarios = "SELECT DISTINCT
	...
	$top_comentarios = mysql_db_query($dbname, $top_comentarios); 

	while ($row = mysql_fetch_array($top_comentarios)){ 
...
?>
			<hr>
			<h5>Todos los Comentarios de <?=$tit_pos_pag?> »
				<a class="btn btn-sitio pull-right" href="dise_tic_all.php?id=<?=$ids?>"><i class="icon-arrow-right"></i></a>
			</h5><hr>
