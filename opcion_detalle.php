...
$dato_pagina = "SELECT * FROM (pagina LEFT JOIN opcion ON pagina.id_pagina = opcion.id_pagina) WHERE pagina.id_pagina='$id'";
						...
						<small>
							<dl class="dl-horizontal text-left">
								...
								<dd>
									<?php
										//Destino
										$dato_destino = "SELECT DISTINCT tour_opcion.id_opcion,destino.id_pagina, pagina.tit_pos_pagina
															FROM
															((((tour
															...
															WHERE
															tour_opcion.id_opcion IN ($id_opcion)";
						...
						<p>
							<?php
								...
								$dato_valoracion = "SELECT 
														...
														FROM
														((opcion LEFT JOIN pagina ON pagina.id_pagina = opcion.id_pagina)
							...
							<ul class="text-left">
								<?php
									...
									$dato_tours_destino = "SELECT DISTINCT tour.id_tour, tour.id_pagina
																FROM
																tour LEFT JOIN tour_opcion ON tour.id_tour = tour_opcion.id_tour
																WHERE id_opcion IN ($id_opcion)
																LIMIT 0, 10";
