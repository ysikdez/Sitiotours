...
$dato_pagina = "SELECT * FROM (pagina LEFT JOIN tipica ON pagina.id_pagina = tipica.id_pagina) WHERE pagina.id_pagina='$id'";
			...
			<div class="row">
				<div class="span8">
					...
					<article class="span8 text-center">
								...
								<dd>
									<?php
										...
										$dato_destino = "SELECT pagina.id_pagina ,destino.id_destino ,pagina.tit_pos_pagina ,pagina.url_pagina
																FROM
																((tipica LEFT JOIN destino ON tipica.id_destino = destino.id_destino)
																LEFT JOIN pagina ON pagina.id_pagina = destino.id_pagina)
																WHERE
																tipica.id_tipica='$id_tipica'";
						...
						<p class="text-justify"><?=$des_tipica?></p>
						<h4 class="text-left">Material :</h4>
						<p class="text-justify"><?=$ing_tipica?></p>
						<h4 class="text-left">Elaboracion :</h4>
						<p class="text-justify"><?=$ela_tipica?></p>
						<br><br>
						<p>
							<?php
